...
def jogador(tabuleiro, cont, player = 1, simbolo = "X"):
...
while True:
    ...
    if(len(contador) < 9):
        ...
        while True:
            jogador1 = jogador(tabuleiro, contador)
    ...
    if(modoJogo == 2 and ganhador == 0 and len(contador) < 9):
    ...
    if(modoJogo == 1 and ganhador == 0 and len(contador) < 9):
    ...
    if(len(contador) > 8 or ganhador != 0):
